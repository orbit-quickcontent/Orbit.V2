      ...
      <div className="bg-[rgba(15,17,21,0.85)] backdrop-blur-2xl border-b border-white/10 shadow-[0_4px_24px_rgba(0,0,0,0.6)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-2.5 sm:py-3">
            ...
            {/* Right: Search + Online Toggle + Notification + Settings */}
            <div className="flex items-center gap-2 sm:gap-3">
              <button
                onClick={() => { setSearchOpen(true); setMenuOpen(false); setSettingsOpen(false); }}
                title="Search Work & Dispatches"
              ...
              <button
                ...
                className="flex items-center gap-1.5 h-9 sm:h-10 px-2.5 rounded-full bg-white/[0.08] border border-white/10 backdrop-blur-lg hover:bg-white/15 transition-all duration-200"
                title={user.isOnline ? "Go Offline" : "Go Online"}
              >
                <div className={`w-2 h-2 rounded-full transition-colors duration-200 ${user.isOnline ? "bg-green-400 shadow-[0_0_6px_#22C55E]" : "bg-gray-400"}`} />
                <span className={`text-[11px] sm:text-xs font-semibold transition-colors duration-200 ${user.isOnline ? "text-green-400" : "text-gray-400"}`}>
              ...
              <button
                ...
                className="md:hidden w-9 h-9 rounded-full bg-white/[0.08] border border-white/10 backdrop-blur-lg flex items-center justify-center text-zinc-300 hover:text-white transition-colors"
              >
                <ChevronDown
            ...
            >
              ...
              <div className="flex items-center justify-between border-b border-white/10 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h3 className="text-base font-bold text-white leading-none">Partner Settings</h3>
                    <p className="text-[11px] text-zinc-400 mt-1">Configure partner dispatch & wallet alerts</p>
                  </div>
                </div>
                <button
                  onClick={() => setSettingsOpen(false)}
              ...
              <div className="space-y-3">
                <p className="text-[11px] font-bold uppercase tracking-wider text-zinc-400">Dispatch & Payout Preferences</p>
                
                <div className="flex items-center justify-between p-3 rounded-xl bg-white/[0.03] border border-white/5">
                  <span className="text-xs font-semibold text-zinc-200">Shoot Dispatch Notifications</span>
                  <button
                ...
                <div className="flex items-center justify-between p-3 rounded-xl bg-white/[0.03] border border-white/5">
                  <span className="text-xs font-semibold text-zinc-200">Payout Transfer Alerts</span>
                  <button
                ...
                <div className="flex items-center justify-between p-3 rounded-xl bg-white/[0.03] border border-white/5">
                  <span className="text-xs font-semibold text-zinc-200">Dispatch Chime & Haptics</span>
                  <button
