...
const logBankAudit = async (_opts: any) => {};
const encryptAccountNumber = (val: string) => val;
const verifyBankAccount = async (..._args: any[]): Promise<any> => ({ success: true, verifiedName: "Partner", bankName: "HDFC", branchName: "Bandra", referenceId: "ref_1", error: null });
